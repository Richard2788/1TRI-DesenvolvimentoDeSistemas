...
def abrir_tela2(janela_pai):
    ...
    # BOTÃO
    botao = tk.Button(janela_pai, text= 'Enviar', command= cadastrar)   # Cria um botão para enviar os dados da inseridos nas entradas de texto, text é texto do botão e command define reações ao usar o botão, neste caso chama a função 'login'
